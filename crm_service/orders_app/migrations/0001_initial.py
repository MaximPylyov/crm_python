# Generated by Django 3.2.8 on 2024-10-19 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.TextField(choices=[('open', 'Открыта'), ('closed', 'Закрыта'), ('in progress', 'В процессе'), ('need info', 'Нужна информация')], default='open', verbose_name='Статус заявки')),
